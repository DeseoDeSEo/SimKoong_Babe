...
<link rel="stylesheet" type="text/css"
	href="Logintemplate/vendor/bootstrap/css/bootstrap.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="Logintemplate/fonts/font-awesome-4.7.0/css/font-awesome.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="Logintemplate/fonts/Linearicons-Free-v1.0.0/icon-font.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="Logintemplate/vendor/animate/animate.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="Logintemplate/vendor/css-hamburgers/hamburgers.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="Logintemplate/vendor/animsition/css/animsition.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="Logintemplate/vendor/select2/select2.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="Logintemplate/vendor/daterangepicker/daterangepicker.css">
<!--===============================================================================================-->
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="${cpath}/join" method="post"
					...
					<input type="hidden" name="_csrf" value="${_csrf.token}" /> <span
						class="login100-form-title p-b-43"> 회원가입 </span>

					<div class="wrap-input100 validate-input"
						data-validate="Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="nickname"> <span
							class="focus-input100"></span> <span class="label-input100">Nickname</span>
					</div>
					...
					<div id="check" class="invalid-feedback mb-1 m-1">비밀번호가 일치하지
						않습니다.</div>
					<!-- 11/27보경 비밀번호 일치 구현  -->
					<div class="wrap-input100 validate-input"
						data-validate="Password is required">
						<input class="input100" type="password" name="confirm_password"
							id="password2" onchange="check()"> <span
							class="focus-input100"></span> <span class="label-input100">Check
							Password</span>
					</div>
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn"
							style="background-color: #d6cbd5;">Join</button>
					</div>

					<div class="text-center p-t-46 p-b-20">

						<span class="txt2"> 이미 계정이 있으신가요? <a href="login"
							style="color: #ff8cb9;">Login</a>
						</span>
				...
				<div class="login100-more"
					style="background-image: url('img/Babe.gif'); position: relative; overflow: hidden;">
					<div class="overlay-text"
						style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center;">
						<span style="font-weight: bold; font-size: 500%; color: #ff3d9e;">Babe.</span>
					</div>
				</div>
			</div>
		</div>
