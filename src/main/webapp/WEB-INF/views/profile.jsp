								...
								<div class="small font-italic text-muted mb-4">
									<form action="/filterUpdate" method="POST">
										...
										<div class="range-slider"
											style="display: flex; flex-direction: column; gap: 10px;">
											<label class="large mb-1" for="inputUsername">
												Minimum Age <span id="MinimumRangeValue"
												style="float: right;">${filter.age_range.get(0)}
													years old</span>
											</label> <input name="lower" type="range" class="form-range"
												id="lower" min="0" max="100" step="1"
												value="${filter.age_range.get(0)}"> <label
												class="large mb-1" for="inputUsername"> Maximum Age
												<span id="MaximumRangeValue" style="float: right;">${filter.age_range.get(1)}
													years old</span>
											</label> <input name="upper" type="range" class="form-range"
												id="upper" min="0" max="100" step="1"
												value="${filter.age_range.get(1)}">
