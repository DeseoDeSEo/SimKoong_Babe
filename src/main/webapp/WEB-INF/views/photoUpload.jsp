				...
				<div class="col-12 text-center">
					...
					<div class="card">
						<div class="card-body mt-3" >
							...
							<c:forEach items="${imageDatas}" var="imageData" varStatus="i" >    
								...
								<div class="responsive">
									<div class="gallery"> 
									<img src="data:image/jpeg;base64,${imageData}" alt="S3 Image" class="rounded" style="width:640px; height:360px;">
						...
						<div class="row">
							...
							<div class="col-sm-2" >
							 	 <a href="/update" class="btn btn-lg btn-lg-square" style="background-color:pink; width:70px; height:70px;"> <i class="bi bi-chevron-right" style="color: white"></i> </a>
							</div>	
						</div>					
						<div>
