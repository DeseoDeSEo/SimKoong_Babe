...
<%--                                     	<button type="submit" class="myButton" id="uploadButton${i.count} style="display:none;">upload</button> --%>
                  ...
                  <div class="row" style="margin-left: 678px;">
                     ...
                     <div class="col-sm-2" >
                          <a href="/update" class="btn btn-lg btn-lg-square" style="transform: translate(-1px, 7px); background-color:pink; width:40px; height:40px;"> <i class="bi bi-chevron-right" style="color: white"></i> </a>
                     </div>   
                  </div>
                  <div>
